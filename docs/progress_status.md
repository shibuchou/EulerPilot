...
- v3.2 剩余争奖增强重点转为：cred_transfer/cred_alloc_blank 等更深 credential hook 评估和最终答辩证据压缩。
...
- `tests/integration/test_security_policy_credential_anomaly.sh` 已在 121/122 真实验证 `credential_churn` credential 生命周期 anomaly 规则；121 结果目录：`results/security_policy/credential-anomaly-20260703-121-v3/`，122 结果目录：`results/security_policy/credential-anomaly-20260703-122-v3/`。
...
- 121 最新正式 `security_policy` credential anomaly 规则证据目录：`results/security_policy/credential-anomaly-20260703-121-v3/`。
- 122 最新正式 `security_policy` credential anomaly 规则证据目录：`results/security_policy/credential-anomaly-20260703-122-v3/`。
