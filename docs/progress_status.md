...
- 121 完整质量门禁已通过：`reports/final_quality_gate_20260623_security_ptrace.log`。
...
- 121 最新完整质量门禁已通过：`reports/final_quality_gate_20260623_security_ptrace.log`，17/17 P0、100 轮 Agent smoke 和 5 轮 doctor 均通过。
