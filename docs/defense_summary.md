...
- SP4 追加复核：`results/final/redis-scx-compare-20260724-tested-2541464-runs10`，当前为 provisional historical
- 趋势/边界证据：`results/final/redis-pressure-gradient-20260708-153811`、`results/final/redis-static-vs-agent-20260724-tested-2541464-runs10`、`results/final/agent-overhead-20260724-tested-2541464-runs10`
- 无效历史证据：`results/final/throughput-first-20260724-tested-2541464-runs10`、`results/final/mixed-adaptive-20260724-tested-2541464-runs10-lite`

### Nginx（`nginx-scx-compare-20260612-194018`）
- `cgroup_v2` 在 Nginx 场景下更稳
- `sched_ext` 效果依赖具体模式，部分模式存在显著尾延迟代价
- SP4 追加复核：`results/final/nginx-scx-compare-20260724-tested-2541464-runs10`，当前为 provisional historical
