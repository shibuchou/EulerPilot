...
def main() -> int:
    ...
    total_requests_match = re.search(r"(\d+)\s+requests in", wrk_output)
    ...
    total_requests = total_requests_match.group(1) if total_requests_match else ""
    ...
    summary_csv.write_text(
        "requests_per_sec,avg_latency,stdev_latency,max_latency,p99_latency,total_requests\n"
        f"{req},{avg_latency},{stdev_latency},{max_latency},{p99},{total_requests}\n",
        encoding="utf-8",
    )
    return 0
