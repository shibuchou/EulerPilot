...
# 6. agent 15s smoke (metrics default closed)
...
# 9. metrics default off + 127.0.0.1
...
if $RESIDUE_OK; then
    ok "no BPF/LSM residue"
else
    not_ok "BPF/LSM residue found"
fi
