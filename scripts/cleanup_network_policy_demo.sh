...
rm -f /sys/fs/bpf/eulerpilot_network_policy_link 2>/dev/null || true
rm -f /sys/fs/bpf/eulerpilot_network_policy_demo_link 2>/dev/null || true
rm -f /sys/fs/bpf/network_policy_demo 2>/dev/null || true
