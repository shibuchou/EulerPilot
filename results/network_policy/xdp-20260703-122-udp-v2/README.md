...
Run directory: `results/network_policy/xdp-20260703-122-udp-v2`
...
- Enforce: Agent attaches XDP generic mode on `ep-veth-xdp0`, blocks ICMP connectivity, and records TCP:`19092` plus UDP:`19093` rule hits.
