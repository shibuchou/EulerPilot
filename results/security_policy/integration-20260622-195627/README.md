# Security Policy integration 20260622-195627

环境：`192.168.1.122`，openEuler 24.03 LTS SP3。

本目录是 `tests/integration/test_security_policy.sh` 在 122 上的通过结果，用于复核 121 上新增的 `file_access=write` Security Policy 行为在第二台 SP3 验证机上一致。
